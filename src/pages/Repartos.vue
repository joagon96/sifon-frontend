            ...
            <md-card>
                ...
                <div class="md-size-100">  
                  <h4 class="title md-size-80">Repartos
                    ...
                    <md-button class="md-raised md-info md-size-20" style="float: right; margin-top: 10px; margin-right: 20px;" @click="showSearchDialog()"><md-icon>tune</md-icon> Filtros</md-button>
                  </h4>
                </div>
                </md-card-header>
            ...
            <div>
              <md-dialog :md-active.sync="searchDialog" style="z-index: 5;">
                ...
                <div class="md-layout-item md-small-size-100 md-size-100">
                  <div class="md-layout md-gutter">
                    <div class="md-layout-item">
                      <md-field>
                        <label>Zona</label>
                        <md-select md-dense v-model="search.idZona">
                          <md-option v-for="z in zonas" :key="z.idZona" :value="z.idZona">{{z.descripcion}}</md-option>
                        </md-select>
                      </md-field>
                    </div>
                    ...
                    <div class="md-layout-item md-size-100">
                          <md-field>
                            <label>Repartidor</label>
                            <md-select md-dense v-model="search.idRepartidor">
                              <md-option v-for="r in repartidores" :key="r.idRepartidor" :value="r.idRepartidor">{{r.nomapeRep}}</md-option>
                            </md-select>
                          </md-field>
                        </div>
                ...
                <md-dialog-actions>
                  ...
                  <md-button class="md-primary" @click="searchRepartos()">Aplicar filtros</md-button>
                </md-dialog-actions>
              </md-dialog>
            </div>
...
export default {
  ...
  methods: {
    ...
    searchRepartos() {
      var bodyFormData = new FormData();
      bodyFormData.append('idZona', this.search.idZona) ;
      bodyFormData.append('dia', this.search.dia) ;
      bodyFormData.append('idRepartidor', this.search.idRepartidor) ;
      axios({
        method: 'POST',
